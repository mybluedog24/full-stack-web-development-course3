describe('Controller: MenuController', function() {
    ...
    // SOLUTION FROM: https://www.coursera.org/learn/angular-js/discussions/weeks/4/threads/jU2haYiNEearVhJfoMXTAQ
  ...
  beforeEach(module(function($urlRouterProvider){
    ...
    it('should have the correct data order in the dish', function(){
